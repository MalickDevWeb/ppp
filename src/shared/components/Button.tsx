...
export function Button({ variant = 'primary', size = 'md', className = '', children, ...props }: ButtonProps) {
  ...
  const variants = {
    primary: 'bg-brand-red-deep text-white hover:bg-[#8F1316] shadow-md shadow-[#B3181C]/15',
    secondary: 'bg-white border border-neutral-gray-200 text-[#291715] hover:bg-neutral-gray-50',
