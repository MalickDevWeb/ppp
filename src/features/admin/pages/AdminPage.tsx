      ...
      <header className="bg-surface docked full-width top-0 sticky z-40 border-b border-neutral-gray-200 flat no shadows">
        <div className="flex justify-between items-center px-margin-mobile h-16 w-full mx-auto">
          ...
          <div className="flex items-center gap-4">
            <button translate="no" className="material-symbols-outlined text-secondary cursor-pointer active:opacity-80">
              search
            </button>
            <button 
              onClick={() => {
              ...
              title="Déconnexion"
              className="w-8 h-8 rounded-full bg-primary-fixed overflow-hidden border border-outline-variant hover:opacity-80 transition-opacity cursor-pointer flex items-center justify-center p-0"
            >
              <img
