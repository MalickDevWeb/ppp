...
export function AITutorPanel() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate real AI tutor answers containing diagnostic simulation references
    setTimeout(() => {
      let aiResponse = "";
  ...
  return (
    <section className="col-span-12 md:col-span-4 bg-white/90 backdrop-blur-md border border-neutral-gray-250 rounded-3xl p-5 shadow-sm flex flex-col justify-between h-[450px]">
