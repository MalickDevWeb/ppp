...
export function LiveStreamBanner({ liveSessions, onJoin }: LiveStreamBannerProps) {
  return (
    <div className="bg-gradient-to-r from-neutral-900 to-brand-red-deep p-6 rounded-3xl text-white mb-8 border border-white/5 shadow-md flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
