    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[260] flex items-center justify-center p-4 animate-fade-in select-none">
      <div className="bg-white rounded-3xl w-full max-w-md border border-neutral-gray-200/50 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="bg-gradient-to-br from-brand-red-deep to-[#7a1012] p-5 text-white flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2"><span className="material-symbols-outlined text-base">support_agent</span><h4 className="font-extrabold text-xs">Centre de Support Académique</h4></div>
        ...
        <form onSubmit={onSendTicket} className="flex-grow flex flex-col overflow-hidden">
          <div className="p-5 space-y-3.5 flex-grow overflow-hidden">
          ...
          <div className="p-4 bg-neutral-gray-50 border-t border-neutral-gray-150 flex justify-end gap-2.5 shrink-0">
            ...
            <button type="submit" disabled={isSendingTicket} className="px-5 py-2 bg-brand-red-deep hover:bg-[#8F1316] text-white text-xs rounded-xl font-bold disabled:opacity-50 transition-all shadow-md flex items-center justify-center gap-1.5 cursor-pointer">
