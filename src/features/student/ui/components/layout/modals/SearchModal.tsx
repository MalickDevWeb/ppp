...
export function SearchModal({ showSearch, setShowSearch, searchQuery, setSearchQuery, filteredSearchItems, onSearchAction }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-[#291715]/40 backdrop-blur-xs z-[100] flex items-start justify-center p-4 pt-10 sm:pt-20 animate-fade-in">
      <div className="bg-white rounded-3xl w-full max-w-lg border border-neutral-gray-200/50 shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
