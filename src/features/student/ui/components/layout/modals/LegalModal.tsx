...
export function LegalModal({ showLegalModal, setShowLegalModal }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[260] flex items-center justify-center p-4 animate-fade-in select-none">
      <div className="bg-white rounded-3xl w-full max-w-sm border border-neutral-gray-200/50 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
        ...
        <div className="flex-grow p-5 overflow-y-auto no-scrollbar font-medium text-[10.5px] text-[#291715] space-y-3.5 leading-relaxed max-h-[55vh]">
