...
export function GradesTable({ grades, onRowClick }: GradesTableProps) {
  return (
    <div className="bg-white border border-neutral-gray-200 rounded-xl overflow-hidden shadow-sm">
      ...
      <div className="p-4 bg-surface-container-low border-t border-neutral-gray-200 text-center">
        <button className="text-primary font-bold font-label-md text-label-md hover:underline active:opacity-80 transition-opacity cursor-pointer">
